  ...
  public static UNG: EdiReleaseSchemaSegment = new EdiReleaseSchemaSegment({
    ...
    Elements: [
      ...
      },
      {
        ...
        Required: true,
        Components: [
          { Id: "0017", Desc: "Date", DataType: "N", Required: true, MinLength: 6, MaxLength: 8, Definition: "Local date when an interchange or a group was prepared. Format is CCYYMMDD.", mock: true },
      ...
      { Id: "0051", Desc: "Controlling agency, coded", DataType: "AN", Required: false, MinLength: 1, MaxLength: 3, Definition: "Code identifying a controlling agency.", mock: true, QualifierRef: "Controlling agency, coded" },
      {
        Id: "S008",
        Desc: "Message version",
        Components: [
          { Id: "0052", Desc: "Message version number", DataType: "AN", Required: true, MinLength: 1, MaxLength: 3, Definition: "Version number of a message type.", mock: true, QualifierRef: "Message version number" },
          { Id: "0054", Desc: "Message release number", DataType: "AN", Required: true, MinLength: 1, MaxLength: 3, Definition: "Release number within the current message version number.", mock: true, QualifierRef: "Message release number" },
    ...
    "Qualifiers": {
      ...
      "Message release number": {
        ...
        "02A": "Release 2002 - A",
        "02B": "Release 2002 - B",
        "3": "Third release, CONTRL message",
        "03A": "Release 2003 - A",
        "03B": "Release 2003 - B",
        "04A": "Release 2004 - A",
        "04B": "Release 2004 - B",
